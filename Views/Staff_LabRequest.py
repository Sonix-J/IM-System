...
"}")
        ...
        self.verticalLayout_3.addWidget(self.LabButton)
...
"")
        ...
        self.SearchBar.setMinimumSize(QtCore.QSize(0, 48))
        self.SearchBar.setMaximumSize(QtCore.QSize(500, 48))
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 732, 560))
        ...
        self.LabRequestTable.setFont(font)
